    ...
    <section id="faq" className="relative py-24 lg:py-32 overflow-hidden bg-white dark:bg-transparent">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1440px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-20">
          ...
          >
            <span className="text-7xl lg:text-9xl font-bold text-gray-200 dark:text-gray-800 leading-none block">
              13
            </span>
            <div className="mt-4 h-1.5 w-20 bg-gradient-to-r from-primary to-secondary rounded-full" />
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/10">
                <PiQuestion className="h-6 w-6 text-primary" />
              </div>
              <span className="text-sm font-bold text-primary uppercase tracking-widest">Support Center</span>
            </div>
            <Title as="h2" className="text-4xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-6 leading-none">
              FAQs
            </Title>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          {faqs.map((faq, i) => (
            ...
            >
              <Collapse
                className="rounded-3xl border border-gray-100 bg-white p-2 shadow-sm transition-all hover:shadow-md dark:bg-gray-100 dark:border-gray-200"
                header={({ open, toggle }: { open?: boolean; toggle: () => void }) => (
                  <button
                    type="button"
                    onClick={toggle}
                    className="flex w-full items-center justify-between py-6 px-8 text-left text-lg lg:text-xl font-bold text-gray-900 dark:text-gray-1000 group"
                  >
              ...
              >
                <div className="px-8 pb-8 pt-2 text-lg text-gray-600 dark:text-gray-800 font-light leading-relaxed whitespace-pre-line border-t border-gray-50 dark:border-gray-200 mt-2">
                  {faq.answer}
                </div>
              </Collapse>
            </motion.div>
        ...
        >
          <div className="inline-block relative p-[1px] rounded-[40px] bg-gradient-to-br from-primary via-secondary to-primary bg-[length:200%_200%] animate-gradient-slow overflow-hidden group">
            <div className="relative bg-white dark:bg-gray-100 rounded-[39px] p-12 lg:px-20">
              <Title as="h3" className="text-3xl lg:text-5xl font-bold text-gray-900 dark:text-gray-1000 mb-4">
                Still have questions?
              </Title>
              <Text className="text-lg lg:text-xl text-gray-600 dark:text-gray-700 font-light mb-10 max-w-2xl mx-auto">
                Our team is here to help you get started on your startup journey.
              </Text>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center gap-3 px-10 py-5 bg-primary text-white font-bold rounded-2xl shadow-xl shadow-primary/20 transition-all hover:shadow-primary/30"
                >
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center gap-3 px-10 py-5 text-gray-900 border-2 border-gray-200 font-bold rounded-2xl transition-all hover:border-primary hover:text-primary shadow-sm"
                >
                  <PiPhoneThin className="h-6 w-6" />
                  +65 9737 1722
                </motion.a>
              </div>
            </div>
