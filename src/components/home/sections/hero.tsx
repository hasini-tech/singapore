      ...
      <div className="relative z-10 mx-auto max-w-[1440px] px-4 text-center sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="ml-2 inline-block bg-gradient-to-r from-secondary via-primary to-secondary bg-clip-text text-transparent">
          ...
          {/* Quick Stats Bar */}
          <div className="mx-auto grid w-full max-w-5xl grid-cols-3 gap-4 border-t border-muted sm:gap-12 lg:gap-24">
        ...
        {/* Scroll Indicator */}
        <div className="mt-4 flex flex-col items-center gap-4 text-gray-400">
