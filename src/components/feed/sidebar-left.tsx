...
import { PiUserCircleFill, PiBookmarkSimple, PiUsers, PiChartLineUp, PiBuildings, PiCalendar } from 'react-icons/pi';
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <motion.div 
        ...
        className="overflow-hidden rounded-2xl border border-gray-100 bg-white dark:border-gray-800 dark:bg-gray-100 dark:text-gray-900 shadow-sm"
      >
        <div className="h-16 w-full bg-gradient-to-r from-primary/30 to-secondary/30" />
        <div className="relative px-4 pb-4">
          ...
          <div className="pt-10">
            <Link href="/profile" className="group">
              <Title as="h3" className="text-lg font-bold group-hover:text-primary transition-colors">
                {displayName}
              </Title>
            </Link>
          ...
          <div className="mt-6 space-y-3 border-t border-gray-50 dark:border-gray-200 pt-4">
            <div className="flex items-center justify-between text-sm">
              <Text className="text-gray-500">Profile views</Text>
              <Text className="font-bold text-primary">
                {loading ? '...' : stats?.profileViews ?? 0}
              </Text>
            </div>
            <div className="flex items-center justify-between text-sm">
              <Text className="text-gray-500">Post impressions</Text>
              <Text className="font-bold text-primary">
      ...
      <motion.div 
        ...
        className="rounded-2xl border border-gray-100 bg-white p-4 dark:border-gray-800 dark:bg-gray-100 dark:text-gray-900 shadow-sm"
      >
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <Title as="h4" className="text-white text-base">Growth Dashboard</Title>
        </div>
        <Text className="text-white/80 text-xs mb-4">
          Track your startup growth metrics and investor engagement in real-time.
        </Text>
        <Button variant="flat" className="w-full bg-white text-primary font-bold hover:bg-white/90">
          View Analytics
        </Button>
      </motion.div>
    </div>
