...
import CNFlagIcon from '@/components/icons/language/CNFlag';
import DEFlagIcon from '@/components/icons/language/DEFlag';
import ESFlagIcon from '@/components/icons/language/ESFlag';
import SAFlagIcon from '@/components/icons/language/SAFlag';
import USFlagIcon from '@/components/icons/language/USFlag';
